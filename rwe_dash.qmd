...
# TO DO:
# - Deutsch/Englisch-Version: https://marioangst.com/de/blog/posts/multi-language-quarto/
#   profile mit seperaten yaml headern anlegen
...
pmk_zs <- read_parquet("data/PMK_neu.parquet")
rwm<-read_rds("data/data_kreise.rds")
...
mainPanel(
  ...
  Die erste Visualisierung skizziert die Mobilisierung von Demonstrationen, welche vom Verfassungsschutz als gesichert rechtsextremistisch eingestuft wurden.<br>
  ...
  Zuletzt wird eine monatliche Zeitreihe für rechtsextremistische Straftaten nach Bundesländern vorgestellt.<br>
  "),
...
mainPanel(
  ...
  Datengrundlage sind 'kleine Anfragen' an den Bundestag durch die Fraktion DIE LINKE. Der Datensatz ist <a href='https://data.gesis.org/sharing/#!Detail/10.7802/2256' target='_blank'>hier</a> abrufbar.<br> 
  Quelle: Kanol, E.; Knoesel, J. (2021): Right-Wing Extremist Mobilization in Germany. Version 1.0.0. WZB Berlin Social Science Center. Dataset."))
)
